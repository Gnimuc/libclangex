...
CXCodeGenAction clang_EmitAssemblyAction_create(CXInit_Error *ErrorCode, LLVMContextRef LLVMCtx) {
...
CXCodeGenAction clang_EmitLLVMAction_create(CXInit_Error *ErrorCode, LLVMContextRef LLVMCtx) {
  CXInit_Error Err = CXInit_NoError;
  std::unique_ptr<clang::CodeGenAction> ptr =
...
CXCodeGenAction clang_EmitLLVMOnlyAction_create(CXInit_Error *ErrorCode, LLVMContextRef LLVMCtx) {
  CXInit_Error Err = CXInit_NoError;
  std::unique_ptr<clang::CodeGenAction> ptr =
...
CXCodeGenAction clang_EmitCodeGenOnlyAction_create(CXInit_Error *ErrorCode, LLVMContextRef LLVMCtx) {
  CXInit_Error Err = CXInit_NoError;
  std::unique_ptr<clang::CodeGenAction> ptr =
