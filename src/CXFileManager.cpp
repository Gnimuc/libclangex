...
CXString clang_DirectoryEntry_getName(CXDirectoryEntry DE) {
  return createRef(static_cast<clang::DirectoryEntry *>(DE)->getName());
}

CXString clang_FileEntry_getName(CXFileEntry FE) {
  return createRef(static_cast<clang::FileEntry *>(FE)->getName());
}

CXString clang_FileEntry_tryGetRealPathName(CXFileEntry FE) {
  return createRef(static_cast<clang::FileEntry *>(FE)->tryGetRealPathName());
}
