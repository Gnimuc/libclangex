...
clang_FileManager_create(CXInit_Error *ErrorCode);

CINDEX_LINKAGE void clang_FileManager_dispose(CXFileManager FM);

CINDEX_LINKAGE CXDirectoryEntry clang_FileManager_getDirectory(
    CXFileManager FM, const char *DirName, bool CacheFailure);

CINDEX_LINKAGE CXFileEntry clang_FileManager_getFile(CXFileManager FM,
                                                       const char *Filename,
                                                       bool OpenFile,
                                                       bool CacheFailure);

CINDEX_LINKAGE CXFileEntry
clang_FileManager_getVirtualFile(CXFileManager FM, const char *Filename,
